...
async function handleWhitelistCommands(message, args) {
    ...
    try {
        ...
        const config = (0, whitelist_1.loadWhitelistConfig)(WHITELIST_CONFIG_PATH);
        switch (subCommand) {
            case 'help':
...
▸ Whitelisted Ports: ${config.portWhitelist.ports.length > 0 ? config.portWhitelist.ports.join(', ') : 'None'}`);
            ...
            case 'enable':
                ...
                if (args[1] === 'ip') {
                    ...
                    (0, whitelist_1.saveWhitelistConfig)(config, WHITELIST_CONFIG_PATH);
            ...
            case 'add':
                ...
                if (args[1] === 'ip') {
                    const ip = args[2];
                    (0, whitelist_1.addIpToWhitelist)(ip, config);
                    (0, whitelist_1.saveWhitelistConfig)(config, WHITELIST_CONFIG_PATH);
                    ...
                    (0, whitelist_1.addPortToWhitelist)(port, config);
                    (0, whitelist_1.saveWhitelistConfig)(config, WHITELIST_CONFIG_PATH);
            ...
            case 'remove':
                ...
                if (args[1] === 'ip') {
                    ...
                    (0, whitelist_1.removeIpFromWhitelist)(ip, config);
                    (0, whitelist_1.saveWhitelistConfig)(config, WHITELIST_CONFIG_PATH);
                    ...
                    (0, whitelist_1.removePortFromWhitelist)(port, config);
                    (0, whitelist_1.saveWhitelistConfig)(config, WHITELIST_CONFIG_PATH);
